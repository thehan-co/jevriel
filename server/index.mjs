...
export async function handleMessage(m){
 ...
 if(m.method==='initialize')return answer(m.id,{protocolVersion:'2025-06-18',capabilities:{tools:{}},serverInfo:{name:'jevriel',version:'0.1.3'},instructions:'Read the JEVRIEL skill. Run jevriel_status first. Returned judgments are advisory. Unknown costs are not zero.'});

...
- 34 offline tests pass: 27 Node checks and 7 Python checks. They cover malformed answers, probability/score consistency, session disabling, failure receipts, source-result parsing, benchmark scoring and a simulated installer with an existing marketplace entry.
